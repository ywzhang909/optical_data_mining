...
class HistoryManager:
    ...
    def save_analysis_results(self, results_dict, axis_image=None, pupil_image=None, params=None):
        """
        ...
        if params:
            ...
            with open(params_path, "w", encoding="utf-8") as f:
                json.dump(self._convert_numpy_types(params), f, indent=2, ensure_ascii=False)

        # Save results
        results_path = self.current_session_dir / "results.json"
        with open(results_path, "w", encoding="utf-8") as f:
            json.dump(self._convert_numpy_types(results_dict), f, indent=2, ensure_ascii=False)
        ...
        version_info = {
            ...
            "data_files": [str(file.name) for file in self.current_session_dir.iterdir() if file.is_file()],
        }
