...
class SpotsInputStagePlugin(InputStage):
...
# Register this plugin for dynamic loading
from .input_stage_registry import InputStageRegistry  # type: ignore
InputStageRegistry.register('SpotsInput', SpotsInputStagePlugin)
