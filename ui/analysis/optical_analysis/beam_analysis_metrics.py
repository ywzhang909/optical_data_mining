...
class BeamAnalysisMetrics:
    ...
    def __init__(self, wavelength_nm=1064, focal_length_mm=3000, aperture_diameter_mm=100):
        """
    ...
    def calculate_all_metrics(
        ...
        # FFT centering
        axis_shifted = shift_to_center_fft(axis_denoise, axis_features["center_x"], axis_features["center_y"])
        pupil_shifted = shift_to_center_fft(pupil_denoise, pupil_features["center_x"], pupil_features["center_y"])
        ...
        bpp_result = calculate_bpp(pupil_diameter_mm, axis_diameter_mm, self.focal_length_mm)
